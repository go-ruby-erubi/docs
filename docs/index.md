# go-ruby-erubi documentation

**Pure-Go, MRI-4.0.5-faithful Ruby erubi (no cgo) — Rails' default ERB template engine**

`go-ruby-erubi/erubi` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `erubi`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `erubi`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`erubi`](https://github.com/go-ruby-erubi/erubi) | the library — Ruby's `erubi` in pure Go |
| [`docs`](https://github.com/go-ruby-erubi/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-erubi.github.io`](https://github.com/go-ruby-erubi/go-ruby-erubi.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-erubi/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-erubi/erubi](https://github.com/go-ruby-erubi/erubi).
