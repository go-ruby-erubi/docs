...
The public API lives at the module root (`github.com/go-ruby-erubi/erubi`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `erubi`, while the surface follows
...
```go
import "github.com/go-ruby-erubi/erubi"
```
...
- **[pkg.go.dev/github.com/go-ruby-erubi/erubi](https://pkg.go.dev/github.com/go-ruby-erubi/erubi)**

The module's [README](https://github.com/go-ruby-erubi/erubi#readme) carries worked
