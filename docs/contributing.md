...
Contributions are welcome. `go-ruby-erubi/erubi` is built to a small set of
...
The library is in [`github.com/go-ruby-erubi/erubi`](https://github.com/go-ruby-erubi/erubi).
This documentation site is in [`github.com/go-ruby-erubi/docs`](https://github.com/go-ruby-erubi/docs).
